...
- [ ] `dotnet build Cross.DataFilter.slnx` — green locally
- [ ] `dotnet test Cross.DataFilter.Tests/Cross.DataFilter.Tests.csproj` — green locally
...
- [ ] There is no other open [pull request](https://github.com/denis-peshkov/Cross.DataFilter/pulls) for the same fix or feature.
